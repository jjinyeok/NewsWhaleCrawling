...
def extract_article_from_naver():
    ...
    # # 기사 리스트 초기화
    # # {기사제목, 기사URL}
    # article_list = naver_crawling.init_articles(driver)

    # # 브라우저 닫기
    # naver_crawling.close_browser(driver)

    # # 기사 리스트 전체 가지고 옴
    # article_list = naver_crawling.complete_articles(article_list)

    # return article_list

    import naver_crawling_no_selenium

    article_list = naver_crawling_no_selenium.init_articles()

    article_list = naver_crawling_no_selenium.complete_articles(article_list)
