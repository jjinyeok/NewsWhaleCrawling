...
def zum_articles_to_db():
    ...
    from zum_articles import extract_article_from_zum

    # 다음 메인뉴스로부터 뉴스 반환
    article_list = extract_article_from_zum()
    ...
    print("Zum articles to DB time :", time.time() - start)  # 현재시각 - 시작시간 = 실행 시간
